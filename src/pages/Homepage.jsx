  ...
  return (
    <PageWrapper>
      <Box position="relative">
        <Image src={images[currentImage]} alt="Church building" transition="all 0.5s ease-in-out" />
        
        <Box w="100%" h="500px" background="#d3c0b0" p="20px" mb="50px">
          <Text fontSize="50px" fontWeight="bold" color="black" textAlign="center">
            Something about the Church
          </Text>
          <Text fontSize="30px" color="black" textAlign="center">
            I still dont know what to fill this space with if we even need it at all?
          </Text>       
        </Box>

        <Box p="0 40px">
          <Box w="55%" h="500px" background="#f6eae1" p="20px" mb="50px">
        ...
        <Image src="/public/logo.png" alt="Church logo" w="25%" h="auto" mb="50px" position="absolute" right="150px" bottom="20px" />
      </Box>

      <Box p="0 40px">
        <Box w="100%" h="500px" background="#d3c0b0" p="20px" mb="50px" position="relative">
          <Text fontSize="40px" fontWeight="bold" color="black" textAlign="center" mb="20px">
            Find Us
          </Text>
        </Box>
      </Box>
